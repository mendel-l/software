...
const ProveedorOffcanvas =forwardRef((props, ref) => {
    ...
    return (
        <>
            <Offcanvas show={addProveedor} onHide={setAddProveedor} className="offcanvas-end customeoff" placement='end'>
				<div className="offcanvas-header">
					<h5 className="modal-title" id="#gridSystemModal">Agregar Proveedor</h5>
					<button type="button" className="btn-close" 
						onClick={()=>setAddProveedor(false)}
					>
                    ...
                    <div className="container-fluid">
                        ...
                        <form onClick={(e)=>handleSubmit(e)}>
                            ...
                            <div>
                                ...
                                <Link to={"#"} onClick={()=>setAddProveedor(false)} className="btn btn-danger light ms-1">Cancelar</Link>
                            </div>
                        </form>
                    </div>
				</div>
