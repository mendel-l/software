...
const Inbox = () => {
  ...
  const [checked, setChecked] = useState(messageBlog);
                                  ...
                                  <div className="d-sm-flex text-center justify-content-between align-items-center pagination">
                                      <div className='dataTables_info'>
                                          Showing {lastIndex-recordsPage + 1} to{" "}
                                           {messageBlog.length < lastIndex ? messageBlog.length : lastIndex}
                                          {" "}of {messageBlog.length} entries
                                      </div>
                                      <ul className="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                        ...
                                        {number.map((n , i )=>(
                                          <li                                                 
                                            className={`page-item ${currentPage === n ? 'active' :  '' } `} key={i}                                            
