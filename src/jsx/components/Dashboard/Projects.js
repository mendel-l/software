...
const advertising = [
    {boxid:'11', title: '1', status:'In Progress',  colorChange: 'purple'},
    {boxid:'12', title: '2', status:'Complete', colorChange: 'success'},
    {boxid:'13', title: '3', status:'Pending', colorChange: 'danger'},
    {boxid:'14', title: '4', status:'In Progress',  colorChange: 'purple'},
    {boxid:'15', title: '5', status:'Pending',  colorChange: 'danger'},
    {boxid:'16', title: '6', status:'Complete', colorChange: 'success'},
    {boxid:'17', title: '7', status:'In Progress', colorChange: 'purple'},
    {boxid:'18', title: '8', status:'Pending', colorChange: 'danger'},
];
                            ...
                            <div className="card box-hover">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="progress mt-4">
                                        <div className={`progress-bar bg-${item.colorChange}`} style={{width:"60%", height:"5px", borderRadius:"4px" }} role="progressbar"></div>
                                    </div>
                                </div>
                                <div className="card-footer d-flex justify-content-between flex-wrap">
                                    <div className="due-progress">
                                        <p className="mb-0 text-secondary">Due <span className={`text-${item.colorChange}`}>: 2023-09-02</span></p>
                                    </div>                                   
