...
function HeadOne({bgcolor}){
    return(
        <div className={`sub-card border-${bgcolor}`}>
            <div className="sub-card-2">
                <div>
                    <h5 className="mb-0">Not Started</h5>
                    <span>Tasks assigned to me: 18</span>
                </div>
                <div className={`icon-box bg-${bgcolor}-light rounded-circle`}>
                    <h5 className={`text-${bgcolor} totalCount`}>18</h5>
                </div>
            </div>
        </div>
    )
...
const initialData = {
    ...
    columns: {
      ...
      "column-2": {
        id: "column-2",
        title: <HeadOne bgcolor="purple"/>,
        taskIds: [4, 5, 6],
      },
      "column-3": {
        id: "column-3",
        title: <HeadOne bgcolor="warning"/>,
        taskIds: [7,8,9],
      },
      "column-4": {
        id: "column-4",
        title: <HeadOne bgcolor="danger"/>,
        taskIds: [10,11,12],
      },
      "column-5": {
        id: "column-5",
        title: <HeadOne bgcolor="success"/>,
        taskIds: [13,14,15],
      },
    },  
